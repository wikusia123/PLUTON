...
.setTimestamp()
        ...
        if(!time) return message.channel.send(
            new MessageEmbed()
            .setTitle(`<a:1603_Animated_Cross:780545335151558656> ERROR`)
            .setDescription(`Podaj czas!`)
            .addField('**Przykład:**', `\`\`\`ini\n [ ${prefix}tempmute @Zielino#6969 69s ]\n\`\`\``)
            .setColor("FF0000")
            .setFooter(
            `Komende użył: ${message.author.tag}`,
        message.author.displayAvatarURL({ dynamic: true })
      ...
      .setTimestamp() 
        ...
        message.channel.send(
            new MessageEmbed()
            .setTitle(`<:mod:858480386152464395> __**WYCISZONO**__ __**TYMCZASOWO**__ __**UŻYTKOWNIKA!**__`)
